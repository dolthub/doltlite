...
proc emit_doltlite_engine_block {} {
  ...
  set doltlite_emitted {
    ...
    doltlite_branch.c doltlite_branches.c doltlite_checkout.c doltlite_tag.c doltlite_ancestor.c doltlite_merge.c doltlite_merge_pass1.c doltlite_merge_pass2.c doltlite_merge_predetect.c doltlite_merge_rebuild.c doltlite_merge_rows.c doltlite_merge_generated.c doltlite_merge_schema.c
