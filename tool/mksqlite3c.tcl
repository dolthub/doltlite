...
proc emit_doltlite_engine_block {} {
  ...
  set doltlite_emitted {
    ...
    chunk_store.c chunk_store_lock.c chunk_store_refs_api.c chunk_store_commit.c chunk_wal.c chunk_refs.c chunk_index.c chunk_index_spool.c chunk_staging.c chunk_file.c
    ...
    doltlite_branch.c doltlite_branches.c doltlite_checkout.c doltlite_tag.c doltlite_ancestor.c doltlite_merge.c doltlite_merge_pass1.c doltlite_merge_pass2.c doltlite_merge_predetect.c doltlite_merge_rebuild.c doltlite_merge_rows.c doltlite_merge_index_key.c doltlite_merge_generated.c doltlite_merge_schema.c
