...
#define PROLLY_DEFAULT_CACHE_BYTES (SQLITE_DEFAULT_CACHE_SIZE<0 \
  ? -(i64)SQLITE_DEFAULT_CACHE_SIZE*1024 \
  : (i64)SQLITE_DEFAULT_CACHE_SIZE*PROLLY_DEFAULT_PAGE_SIZE)
...
int doltliteBtreePrepareBackupBranch(Btree*, ChunkStore*, char**, ProllyHash*);
