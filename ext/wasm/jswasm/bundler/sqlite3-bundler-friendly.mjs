...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('sqlite3-bundler-friendly.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('sqlite3-bundler-friendly.wasm', import.meta.url).href;
...
// include: ./bld/post-js.bundler.js
/**
...
globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  sqlite3.version = {"libVersion": "3.54.0", "libVersionNumber": 3054000, "sourceId": "2026-04-15 14:41:25 cb910047edc591102dd4ed0d57c863b366981b8aa1d3085d5f95b1fbbabfalt1","downloadVersion": 3540000,"scm":{ "sha3-256": "cb910047edc591102dd4ed0d57c863b366981b8aa1d3085d5f95b1fbbabfalt1","branch": "trunk","tags": "","datetime": "2026-04-15T14:41:25.480Z"}};
});
/**
  2022-07-08
...
// end include: ./bld/post-js.bundler.js
...
(function(){
  ...
  */
  const sIMS = globalThis.sqlite3InitModuleState = Object.assign(Object.create(null),{
    ...
    */
    wasmFilename: 'sqlite3-bundler-friendly.wasm' /* replaced by the build process */
  });
  sIMS.debugModule =
