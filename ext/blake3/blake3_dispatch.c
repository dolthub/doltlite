...
**
** Replaces the doltlite-original blake3_dispatch_portable.c shim. This
** is upstream BLAKE3 dispatch with runtime CPU feature detection on
** x86 (SSE2/SSE4.1/AVX2/AVX-512) and unconditional NEON on aarch64.
** On other targets (e.g. wasm32) the IS_X86/BLAKE3_USE_NEON guards
** compile down to portable-only calls. */
