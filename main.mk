...
SRC += \
  ...
  $(TOP)/src/prolly_btree_cursor_seek.c \
...
chunk_store_refs_api.o:	$(TOP)/src/chunk_store_refs_api.c $(TOP)/src/chunk_store_int.h $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/chunk_store_refs_api.c

chunk_store_commit.o:	$(TOP)/src/chunk_store_commit.c $(TOP)/src/chunk_store_int.h $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/chunk_store_commit.c
...
prolly_btree_cursor_seek.o:	$(TOP)/src/prolly_btree_cursor_seek.c $(TOP)/src/prolly_btree_int.h $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/prolly_btree_cursor_seek.c
...
doltlite_at.o:	$(TOP)/src/doltlite_at.c $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/doltlite_at.c

doltlite_blame.o:	$(TOP)/src/doltlite_blame.c $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/doltlite_blame.c
...
doltlite_merge_rebuild.o:	$(TOP)/src/doltlite_merge_rebuild.c $(TOP)/src/doltlite_merge_int.h $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/doltlite_merge_rebuild.c
...
doltlite_merge_index_key.o:	$(TOP)/src/doltlite_merge_index_key.c $(TOP)/src/doltlite_merge_int.h $(DEPS_OBJ_COMMON)
	$(T.cc.sqlite) -c $(TOP)/src/doltlite_merge_index_key.c
...
ifeq ($(DOLTLITE_PROLLY),1)
  # Filter out files replaced by prolly engine from test sources
  TESTSRC2_FILTERED = $(filter-out %/btree.c %/pager.c %/wal.c %/backup.c,$(TESTSRC2))
  TESTFIXTURE_SRC0 = $(TESTSRC2_FILTERED) $(libsqlite3.LIB)
else
...
DOLTLITE_C_TESTS = \
	...
	prolly_cache_budget_test$(T.exe) \
...
authorizer_internal_sql_test$(T.exe): $(TOP)/test/authorizer_internal_sql_test.c libdoltlite$(T.lib)
	$(T.link) -I. -I$(TOP)/src -o $@ $(TOP)/test/authorizer_internal_sql_test.c \
		libdoltlite$(T.lib) -lz -lpthread -lm
...
vc_commit_hook_test$(T.exe): $(TOP)/test/vc_commit_hook_test.c libdoltlite$(T.lib)
	$(T.link) -I. -I$(TOP)/src -o $@ $(TOP)/test/vc_commit_hook_test.c \
		libdoltlite$(T.lib) -lz -lpthread -lm
...
concurrent_commit_test$(T.exe): $(TOP)/test/concurrent_commit_test.c libdoltlite$(T.lib)
	$(T.link) -I. -I$(TOP)/src -o $@ $(TOP)/test/concurrent_commit_test.c \
		libdoltlite$(T.lib) -lz -lpthread -lm
...
prolly_txn_stress_test$(T.exe): $(TOP)/test/prolly_txn_stress_test.c libdoltlite$(T.lib)
	$(T.link) -I. -I$(TOP)/src -o $@ $(TOP)/test/prolly_txn_stress_test.c \
		libdoltlite$(T.lib) -lz -lpthread -lm
...
prolly_cache_budget_test$(T.exe): $(TOP)/test/prolly_cache_budget_test.c libdoltlite$(T.lib)
	$(T.link) -I. -I$(TOP)/src -DDOLTLITE_PROLLY=1 -D_HAVE_SQLITE_CONFIG_H \
		-o $@ $(TOP)/test/prolly_cache_budget_test.c \
		libdoltlite$(T.lib) -lz -lpthread -lm
