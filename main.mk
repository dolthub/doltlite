...
PROLLY_OBJS = $(DOLTLITE_AUTH_OBJS) \
              ...
              chunk_store.o chunk_store_lock.o chunk_store_refs_api.o chunk_wal.o chunk_refs.o chunk_index.o chunk_staging.o chunk_file.o prolly_cursor.o prolly_mutmap.o prolly_chunker.o \
...
ifeq ($(DOLTLITE_PROLLY),1)
  ...
  DOLTLITE_EXTRA_TSRC = \
    ...
    $(TOP)/src/chunk_store_lock.c $(TOP)/src/chunk_store_refs_api.c $(TOP)/src/chunk_wal.c $(TOP)/src/chunk_refs.c $(TOP)/src/chunk_index.c \
    ...
    $(TOP)/src/doltlite_branch.c $(TOP)/src/doltlite_branches.c $(TOP)/src/doltlite_checkout.c $(TOP)/src/doltlite_tag.c $(TOP)/src/doltlite_ancestor.c \
