...
#define OP_BitAnd        104 /* same as TK_BITAND, synopsis: r[P3]=r[P1]&r[P2] */
#define OP_BitOr         105 /* same as TK_BITOR, synopsis: r[P3]=r[P1]|r[P2] */
#define OP_ShiftLeft     106 /* same as TK_LSHIFT, synopsis: r[P3]=r[P2]<<r[P1] */
#define OP_ShiftRight    107 /* same as TK_RSHIFT, synopsis: r[P3]=r[P2]>>r[P1] */
#define OP_Add           108 /* same as TK_PLUS, synopsis: r[P3]=r[P1]+r[P2] */
#define OP_Subtract      109 /* same as TK_MINUS, synopsis: r[P3]=r[P2]-r[P1] */
#define OP_Multiply      110 /* same as TK_STAR, synopsis: r[P3]=r[P1]*r[P2] */
#define OP_Divide        111 /* same as TK_SLASH, synopsis: r[P3]=r[P2]/r[P1] */
#define OP_Remainder     112 /* same as TK_REM, synopsis: r[P3]=r[P2]%r[P1] */
#define OP_Concat        113 /* same as TK_CONCAT, synopsis: r[P3]=r[P2]+r[P1] */
#define OP_OpenRead      114 /* synopsis: root=P2 iDb=P3                   */
#define OP_OpenWrite     115 /* synopsis: root=P2 iDb=P3                   */
#define OP_BitNot        116 /* same as TK_BITNOT, synopsis: r[P2]= ~r[P1] */
#define OP_OpenDup       117
#define OP_OpenAutoindex 118 /* synopsis: nColumn=P2                       */
#define OP_String8       119 /* same as TK_STRING, synopsis: r[P2]='P4'    */
...
#define OP_Real          155 /* same as TK_FLOAT, synopsis: r[P2]=P4       */
...
/*  96 */ 0x40, 0x00, 0x00, 0x00, 0x10, 0x10, 0x00, 0x40,\
/* 104 */ 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26,\
/* 112 */ 0x26, 0x26, 0x40, 0x00, 0x12, 0x40, 0x40, 0x10,\
...
/* 152 */ 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x06, 0x10,\
