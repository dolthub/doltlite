...
*/
/* Hash score: 232 */
/* zKWText[] encodes 1014 bytes of keyword text in 671 bytes */
...
static const unsigned char aKWLen[149] = {0,
...
static const unsigned short int aKWOffset[149] = {0,
...
static const unsigned char aKWCode[149] = {0,
  ...
  TK_ALWAYS,     TK_WHEN,       TK_WHERE,      TK_RECURSIVE,  TK_WITHIN,     
  TK_INITIALLY,  TK_ALL,        TK_ABORT,      TK_AFTER,      TK_RENAME,     
  TK_AND,        TK_DROP,       TK_PARTITION,  TK_AUTOINCR,   TK_TO,         
  TK_IN,         TK_CAST,       TK_COLUMNKW,   TK_COMMIT,     TK_CONFLICT,   
  TK_JOIN_KW,    TK_CTIME_KW,   TK_CTIME_KW,   TK_CURRENT,    TK_PRECEDING,  
  TK_FAIL,       TK_LAST,       TK_FILTER,     TK_REPLACE,    TK_FIRST,      
  TK_FOLLOWING,  TK_FROM,       TK_JOIN_KW,    TK_LIMIT,      TK_IF,         
  TK_ORDER,      TK_RESTRICT,   TK_OTHERS,     TK_OVER,       TK_RETURNING,  
  TK_JOIN_KW,    TK_ROLLBACK,   TK_ROWS,       TK_ROW,        TK_UNBOUNDED,  
  TK_UNION,      TK_USING,      TK_VACUUM,     TK_VIEW,       TK_WINDOW,     
  TK_DO,         TK_BY,         TK_PRIMARY,    
};
/* Hash table decoded:
**   0: INSERT
**   1: IS
