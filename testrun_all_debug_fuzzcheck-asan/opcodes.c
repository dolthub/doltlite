...
const char *sqlite3OpcodeName(int i){
 static const char *const azName[] = {
    ...
    /* 104 */ "BitAnd"           OpHelp("r[P3]=r[P1]&r[P2]"),
    /* 105 */ "BitOr"            OpHelp("r[P3]=r[P1]|r[P2]"),
    /* 106 */ "ShiftLeft"        OpHelp("r[P3]=r[P2]<<r[P1]"),
    /* 107 */ "ShiftRight"       OpHelp("r[P3]=r[P2]>>r[P1]"),
    /* 108 */ "Add"              OpHelp("r[P3]=r[P1]+r[P2]"),
    /* 109 */ "Subtract"         OpHelp("r[P3]=r[P2]-r[P1]"),
    /* 110 */ "Multiply"         OpHelp("r[P3]=r[P1]*r[P2]"),
    /* 111 */ "Divide"           OpHelp("r[P3]=r[P2]/r[P1]"),
    /* 112 */ "Remainder"        OpHelp("r[P3]=r[P2]%r[P1]"),
    /* 113 */ "Concat"           OpHelp("r[P3]=r[P2]+r[P1]"),
    /* 114 */ "OpenRead"         OpHelp("root=P2 iDb=P3"),
    /* 115 */ "OpenWrite"        OpHelp("root=P2 iDb=P3"),
    /* 116 */ "BitNot"           OpHelp("r[P2]= ~r[P1]"),
    /* 117 */ "OpenDup"          OpHelp(""),
    /* 118 */ "OpenAutoindex"    OpHelp("nColumn=P2"),
    /* 119 */ "String8"          OpHelp("r[P2]='P4'"),
